...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Admin Panel</title>
    <link rel="icon" type="image/png" href="/src/blox.png">
    ...
    <meta property="og:url" content="www.rbxheist.com">
    <style>
...
<body class="bg-black">
    <div class="flex">
        <div class="md:container md:flex-col md:h-screen md:w-1/4 md:bg-gray-800 rounded-b-xl">
            ...
            <button onclick="window.location.href = '/admin.php'" class="md:text-white md:text-3xl md:font-bold md:flex md:w-full md:justify-center md:py-8 ">
                <p class="md:bg-slate-100 md:text-black md:text-2xl md:font-medium md:p-2 md:rounded-xl">Quizz Management</p>
            </button>
    ...
    <div class="md:flex md:justify-between md:space-x-40">
        <p class="md:text-4xl md:text-white md:font-bold">Upload:</p>
        <p class="md:text-2xl bg-red-500 py-2 px-3 rounded-lg md:text-[#F1F1F1] md:font-bold">one image at a time</p>
    </div>
    ...
    <div class="md:bg-white md:my-10 md:rounded-lg md:h-fit py-8">
        ...
        <div class="justify-center flex my-16 space-x-4">
            <button onclick="submitData()">
                <p class="font-bold text-xl bg-green-800 p-2.5 rounded-xl text-white">Submit</p>
            </button>
        </div>
    </div>
</div>
...
<script>
    function submitData() {
        ...
        var url = "adminprocessor.php?request=uploader";
